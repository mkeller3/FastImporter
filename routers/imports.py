...
@router.post("/geographic_data_from_csv/", tags=["import"], response_model=models.BaseResponseModel)
...
@router.post("/point_data_from_csv/", tags=["import"], response_model=models.BaseResponseModel)
